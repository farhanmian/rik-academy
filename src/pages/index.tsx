  ...
  return (
    <>
      <header className={styles.header}>
        ...
        >
          <div className="max-w-2xl mb-10  md:-mt-80 ">
            <h1 className="mb-8 md:-mt-80">
              Join the Digital Revolution, <br /> and become a blockchain expert
              from anywhere with our online coures{" "}
            </h1>
