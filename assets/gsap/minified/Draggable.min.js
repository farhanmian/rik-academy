...
!(function (e, t) {
  ...
  function X() {
    return xe || (W() && (xe = window.gsap) && xe.registerPlugin && xe);
  }
  function Y(e) {
  ...
  function sa(e, t) {
    for (var n, o = e.length; o--; )
      t
        ...
        (n = e[o].children) && n.length && sa(n, t);
  }
  function ta() {
  ...
  function va() {
    return !Re.length && xe.ticker.remove(ta);
  }
  function wa(e) {
  ...
  function Ca(e) {
    (Pe = e.touches && Le < e.touches.length), za(e.target, "touchend", Ca);
  }
  function Da(e) {
    (Pe = e.touches && Le < e.touches.length), ya(e.target, "touchend", Ca);
  }
  function Ea(e) {
    return (
      ye.pageYOffset ||
  ...
  function Ga(e, t) {
    ya(e, "scroll", t), We(e.parentNode) || Ga(e.parentNode, t);
  }
  function Ha(e, t) {
  ...
  function Ja(e, t) {
    ...
    return Math.max(
      0,
      We(e)
        ? Math.max(ve[o], l[o]) - (ye["inner" + n] || ve[r] || l[r])
        : e[o] - e[r]
    );
  }
  function Ka(e, t) {
  ...
  function Oa(e) {
    ...
    var t = e.ownerDocument || me,
      n = $(e.pageX)
        ? e.nodeType || $(e.left) || $(e.top)
          ? Te(e)[0].getBoundingClientRect()
          : e
        : {
            left: e.pageX - Fa(t),
            top: e.pageY - Ea(t),
            right: e.pageX - Fa(t) + 1,
            bottom: e.pageY - Ea(t) + 1,
          };
    return (
      $(n.right) && !$(n.width)
  ...
  function Ta(r, i, e, t, a, n) {
    ...
    if (i)
      if (1 !== a && i instanceof Array) {
        if (((c.end = o = []), (s = i.length), Z(i[0])))
          for (l = 0; l < s; l++) o[l] = qa(i[l], a);
  ...
  function Va(e, t) {
    for (var n, o = e.length; o--; )
      ((n = e[o]).ondragstart = n.onselectstart = t ? null : _),
  ...
  function $a(e) {
    if (W() && document.body) {
      ...
      (ye = window),
        ...
        (l = me.body),
        (s = ea("div")),
        (Xe = !!window.PointerEvent),
        ((we = ea("div")).style.cssText =
        ...
        (Ee =
          ("ontouchstart" in ve && "orientation" in ye) ||
        ...
        ya(me, "touchcancel", _),
        ya(ye, "touchmove", _),
        l && l.addEventListener("touchstart", _),
        ya(me, "contextmenu", function () {
  ...
  var xe,
    ...
    B = function _getElementBounds(e, t) {
      ...
      if (e === ye)
        ...
        if (t === ye || $(t)) return e.getBoundingClientRect();
        (n = r = 0),
          g
  ...
  function Draggable(h, p) {
    ...
    function wh(e) {
      return (
        Aa(e), e.stopImmediatePropagation && e.stopImmediatePropagation(), !1
      );
    }
    function xh(e) {
      if (j.autoScroll && j.isDragging && (te || L)) {
        ...
        for (
          ...
          (t = (n = We(c.parentNode)) ? He : c.parentNode),
            (o = n
              ? {
                  bottom: Math.max(ve.clientHeight, ye.innerHeight || 0),
                  right: Math.max(ve.clientWidth, ye.innerWidth || 0),
                  left: 0,
                  top: 0,
                }
            ...
            n &&
              (a || l) &&
              (ye.scrollTo(t.scrollLeft, t.scrollTop),
      ...
      if (L) {
        ...
        G
          ...
          ? (U && ((j.deltaY = u - f.top()), f.top(u)),
            J && ((j.deltaX = p - f.left()), f.left(p)))
          : W
          ? (U && ((j.deltaY = u - parseFloat(se.y)), (se.y = u + "px")),
            J && ((j.deltaX = p - parseFloat(se.x)), (se.x = p + "px")),
            se.renderTransform(1, se))
          : (U &&
          ...
          !g ||
            e ||
            F ||
            (!(F = !0) === Pa(j, "drag", "onDrag") &&
              (J && (j.x -= j.deltaX), U && (j.y -= j.deltaY), xh(!0)),
            (F = !1));
      }
      L = !1;
    }
    function yh(e, t) {
      ...
      h._gsap || (se = xe.core.getCache(h)),
        ...
        W
          ...
          : ((j.y = parseFloat(h.style.top || ((o = Ma(h)) && o.top)) || 0),
        ...
        (_ || N || k) &&
          ...
          (k &&
            ((Ie.x = j.x),
            (Ie.y = j.y),
            (n = k(Ie)).x !== j.x && ((j.x = n.x), (L = !0)),
            n.y !== j.y && ((j.y = n.y), (L = !0))),
          _ &&
            (n = _(j.x)) !== j.x &&
            ((j.x = n), G && (j.rotation = n), (L = !0)),
          N && ((n = N(j.y)) !== j.y && (j.y = n), (L = !0))),
        L && xh(!0),
        e ||
          ((j.deltaX = j.x - r),
          (j.deltaY = j.y - i),
          Pa(j, "throwupdate", "onThrowUpdate"));
    }
    function zh(a, l, s, n) {
      return (
        null == l && (l = -Oe),
    ...
    function Bh() {
      ...
      (M = !1),
        f
          ? (f.calibrate(),
            (j.minX = D = -f.maxScrollLeft()),
            (j.minY = X = -f.maxScrollTop()),
            (j.maxX = P = j.maxY = S = 0),
            (M = !0))
          : p.bounds &&
            ((e = Qa(p.bounds, h.parentNode)),
            G
              ? ((j.minX = D = e.left),
                (j.maxX = P = e.left + e.width),
                (j.minY = X = j.maxY = S = 0))
              : $(p.bounds.maxX) && $(p.bounds.maxY)
              ? ((t = Qa(h, h.parentNode)),
                (j.minX = D = Math.round(Pg(V, "px") + e.left - t.left)),
                (j.minY = X = Math.round(Pg(K, "px") + e.top - t.top)),
                (j.maxX = P = Math.round(D + (e.width - t.width))),
                (j.maxY = S = Math.round(X + (e.height - t.height))))
              : ((e = p.bounds),
                (j.minX = D = e.minX),
                (j.minY = X = e.minY),
                (j.maxX = P = e.maxX),
                (j.maxY = S = e.maxY)),
            P < D && ((j.minX = P), (j.maxX = P = D), (D = j.minX)),
            S < X && ((j.minY = S), (j.maxY = S = X), (X = j.minY)),
            G && ((j.minRotation = D), (j.maxRotation = P)),
            (M = !0)),
        p.liveSnap &&
          ((n = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (o = Ne(n) || Y(n)),
          G
            ? ((_ = zh(o ? n : n.rotation, D, P, 1)), (N = null))
            : n.points
            ? (k = (function buildPointSnapFunc(s, l, c, d, p, u, h) {
                return (
                  ...
                  Y(s)
                    ...
                    ? function (e) {
                        for (
                          var t, n, o, r, i = s.length, a = 0, l = Oe;
                          -1 < --i;
              ...
              })(o ? n : n.points, D, P, X, S, n.radius, f ? -1 : 1))
            : (J &&
                (_ = zh(
    ...
    function Ch() {
      (j.isThrowing = !1), Pa(j, "throwcomplete", "onThrowComplete");
    }
    function Dh() {
      j.isThrowing = !1;
    }
    function Eh(e, t) {
      ...
      e && Ye
        ? (!0 === e &&
            ...
            G
              ? (e.rotation = Ta(j, o ? n : n.rotation, P, D, 1, t))
              : (J &&
                  (e[V] = Ta(
                    j,
                ...
                (n.points || (Ne(n) && Z(n[0]))) &&
                  ((e.linkedProps = V + "," + K), (e.radius = n.radius)))),
          (j.isThrowing = !0),
    ...
    function Gh() {
      ...
      W &&
        ...
        (w = Ge.x),
        (b = Ge.y),
        L && (he(j.pointerX, j.pointerY), xh(!0)),
        (d = getGlobalMatrix(h)),
        f
          ? (Bh(), (E = f.top()), (T = f.left()))
          : (pe() ? (yh(!0, !0), Bh()) : j.applyBounds(),
            G
              ? ((e = h.ownerSVGElement
                ...
                (n = C.y - j.pointerY + i),
                (T = j.x),
                (E = j.y = Math.atan2(n, t) * ke))
              : ((E = Pg(K, "px")), (T = Pg(V, "px")))),
        M &&
          o &&
          (P < T ? (T = P + (T - P) / o) : T < D && (T = D - (D - T) / o),
          G ||
            (S < E ? (E = S + (E - S) / o) : E < X && (E = X - (X - E) / o))),
        (j.startX = T = ca(T)),
        (j.startY = E = ca(E));
    }
    function Ih() {
    ...
    function Jh(e, t) {
      ...
      if (
        ...
        if (
          ...
          Me[e.type]
            ? ((v = ~e.type.indexOf("touch")
              ...
              ya(v, "touchcancel", fe),
              ya(de, "touchstart", Da))
            : ((v = null), ya(de, "mousemove", ue)),
          (B = null),
          (Xe && v) ||
            (ya(de, "mouseup", fe),
            e && e.target && ya(e.target, "mouseup", fe)),
          (m = ae.call(j, e.target) && !1 === p.dragClickables && !t))
        )
          return (
            ya(e.target, "change", fe),
            Pa(j, "pressInit", "onPressInit"),
            Pa(j, "press", "onPress"),
            Va(Q, !0),
            void (I = !1)
          );
        if (
          ...
          (I = !R && !j.allowEventDefault) &&
            (Aa(e), ya(ye, "touchforcechange", Aa)),
          e.changedTouches
            ? ((e = x = e.changedTouches[0]), (y = e.identifier))
            : e.pointerId
            ? (y = e.pointerId)
            : (x = y = null),
          Le++,
          (function _addToRenderQueue(e) {
            Re.push(e), 1 === Re.length && xe.ticker.add(ta);
          })(xh),
          (b = j.pointerY = e.pageY),
          (w = j.pointerX = e.pageX),
          Pa(j, "pressInit", "onPressInit"),
          (R || j.autoScroll) && Ka(h.parentNode),
          !h.parentNode ||
            !j.autoScroll ||
            f ||
            G ||
          ...
          (!p.zIndexBoost && (G || f || !1 === p.zIndexBoost)) ||
    ...
    function Oh(e) {
      ...
      if (
        ...
        return l && r && (c = le), void (z = le);
      (j.isPressed || o || n) && ((l && e.detail && n && !i) || Aa(e)),
        n ||
          o ||
          H ||
          (e && e.target && (j.pointerEvent = e), Pa(j, "click", "onClick"));
    }
    function Ph(e) {
      return O
        ? { x: e.x * O.a + e.y * O.c + O.e, y: e.x * O.b + e.y * O.d + O.f }
        : { x: e.x, y: e.y };
    }
    var u,
      f,
      ...
      K = W ? "y" : "top",
      J = !(!~n.indexOf("x") && !~n.indexOf("left") && "scroll" !== n),
      ...
      ue = function onMove(e) {
        ...
        if (u && !Pe && j.isPressed && e) {
          ...
          R &&
          !B &&
          ((Ge.x = e.pageX - (ce ? Fa(de) : 0)),
          (Ge.y = e.pageY - (ce ? Ea(de) : 0)),
          O && O.apply(Ge, Ge),
          (n = Ge.x),
          (o = Ge.y),
          (((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) &&
            ...
            (De && R === B)) &&
            ((B = a < i && J ? "x" : "y"),
            R && B !== R && ya(ye, "touchforcechange", Aa),
            !1 !== j.vars.lockAxisOnTouchScroll &&
              J &&
              U &&
              ((j.lockedAxis = "x" === B ? "y" : "x"),
              Y(j.vars.onLockAxis) && j.vars.onLockAxis.call(j, l)),
            De && R === B))
            ? fe(l)
            : ((I =
                j.allowEventDefault ||
      ...
      he = function setPointerPosition(e, t, n) {
        ...
        (j.pointerX = e),
          ...
          G
            ...
            : (O &&
              ...
              (j.lockAxis || j.lockedAxis) &&
                ...
                ((s = j.lockedAxis) ||
                  ((j.lockedAxis = s =
                    J && Math.abs(o) > Math.abs(r) ? "y" : U ? "x" : null),
                  s &&
                    Y(j.vars.onLockAxis) &&
          ...
          M &&
            (P < i
              ? (i = P + Math.round((i - P) * d))
              : i < D && (i = D + Math.round((i - D) * d)),
            G ||
              (S < a
                ? (a = Math.round(S + (a - S) * d))
                : a < X && (a = Math.round(X + (a - X) * d)))),
          (j.x === i && (j.y === a || G)) ||
            (G
              ? ((j.endRotation = j.x = j.endX = i), (L = !0))
              : (U && ((j.y = j.endY = a), (L = !0)),
                J && ((j.x = j.endX = i), (L = !0))),
            n && !1 === Pa(j, "move", "onMove")
              ? ((j.pointerX = p),
                (j.pointerY = u),
                (E = h),
                (j.x = f),
              ...
              : !j.isDragging &&
                j.isPressed &&
                ((j.isDragging = H = !0), Pa(j, "dragstart", "onDragStart")));
      },
      fe = function onRelease(e, t) {
        if (
          ...
          (!e ||
            ...
            t ||
            !(
              (e.pointerId && e.pointerId !== y && e.target !== h) ||
              (e.changedTouches &&
          ...
          var n,
            ...
            d = xe.delayedCall(0.001, Ih);
          if (
            (v
              ? (za(v, "touchend", onRelease),
                za(v, "touchmove", ue),
                za(v, "touchcancel", onRelease),
                za(de, "touchstart", Da))
              : za(de, "mousemove", ue),
            za(ye, "touchforcechange", Aa),
            (Xe && v) ||
              (za(de, "mouseup", onRelease),
              e && e.target && za(e.target, "mouseup", onRelease)),
            (L = !1),
            s && ((ee = ze = Ae()), (j.isDragging = !1)),
            wa(xh),
            m && !c)
          )
            return (
              e && (za(e.target, "change", onRelease), (j.pointerEvent = l)),
              Va(Q, !1),
              Pa(j, "release", "onRelease"),
              Pa(j, "click", "onClick"),
              void (m = !1)
            );
          for (o = Q.length; -1 < --o; )
            La(Q[o], "cursor", p.cursor || (!1 !== p.cursor ? Se : null));
          if ((Le--, e)) {
            if (
              (n = e.changedTouches) &&
              (e = n[0]) !== x &&
              ...
              for (
                o = n.length;
                -1 < --o && (e = n[o]).identifier !== y && e.target !== h;
          ...
          return (
            c && l
              ? (Aa(l), (I = !0), Pa(j, "release", "onRelease"))
              : l && !s
              ? ((I = !1),
                A && (p.snap || p.bounds) && Eh(p.inertia || p.throwProps),
                Pa(j, "release", "onRelease"),
                (De && "touchmove" === l.type) ||
                  -1 !== l.type.indexOf("cancel") ||
                  (Pa(j, "click", "onClick"),
                  Ae() - le < 300 && Pa(j, "doubleclick", "onDoubleClick"),
                  (i = l.target || h),
                  (le = Ae()),
                  ...
                  De || l.defaultPrevented || xe.delayedCall(0.05, a)))
              : (Eh(p.inertia || p.throwProps),
                j.allowEventDefault ||
                !l ||
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        var n, o, r, i;
        Jh(e || j.pointerEvent, !0),
          t &&
            !j.hitTest(e || j.pointerEvent) &&
            ((n = Oa(e || j.pointerEvent)),
            (o = Oa(h)),
            (r = Ph({ x: n.left + n.width / 2, y: n.top + n.height / 2 })),
            (i = Ph({ x: o.left + o.width / 2, y: o.top + o.height / 2 })),
            (w -= r.x - i.x),
            (b -= r.y - i.y)),
          j.isDragging ||
            ((j.isDragging = H = !0), Pa(j, "dragstart", "onDragStart"));
      ...
      (e.timeSinceDrag = function () {
        return j.isDragging ? 0 : (Ae() - ee) / 1e3;
      }),
      ...
      (e.getDirection = function (e, t) {
        var n,
          ...
          a,
          l,
          s = "velocity" === e && Ye ? e : Z(e) && !G ? "element" : "start";
        return (
          "element" === s && ((a = Oa(j.target)), (l = Oa(e))),
          (n =
            "start" === s
              ? j.x - T
              : "velocity" === s
        ...
        if ((yh(!0), Bh(), M && !pe())) {
          if (
            ...
            for (
              ...
              (a = (l = We(i.parentNode)) ? He : i.parentNode),
                U &&
                ...
                (i = a);
          j.isThrowing &&
            (r || j.endX > P || j.endX < D || j.endY > S || j.endY < X) &&
            Eh(p.inertia || p.throwProps, r);
        }
        return j;
      }),
      (e.update = function (e, t, n) {
        ...
        return (
          Fh(!t),
          e ? j.applyBounds() : (L && n && xh(!0), yh(!0)),
          t && (he(j.pointerX, j.pointerY), L && xh(!0)),
          j.isPressed &&
            !t &&
            ((J && 0.01 < Math.abs(a - j.x)) ||
              (U && 0.01 < Math.abs(l - j.y) && !G)) &&
            Gh(),
          j.autoScroll &&
            (Ka(h.parentNode, j.isDragging),
            (te = j.isDragging),
            xh(!0),
            Ha(h, Nh),
            Ga(h, Nh)),
        ...
        if (
          ...
          for (
            ...
            (o = Q[n]),
              ...
              p.allowContextMenu || ya(o, "contextmenu", wh);
          Va(Q, !1);
        }
        return (
          Ga(h, Nh),
          ...
          Ye &&
            "soft" !== e &&
            Ye.track(f || h, W ? "x,y" : G ? "rotation" : "top,left"),
          (h._gsDragID = t = "d" + Fe++),
          (Be[t] = j),
      ...
      (e.disable = function (e) {
        for (var t, n = j.isDragging, o = Q.length; -1 < --o; )
          La(Q[o], "cursor", null);
        if ("soft" !== e) {
          for (sa(Q, null), o = Q.length; -1 < --o; )
            (t = Q[o]),
              La(t, "touchCallout", null),
              za(t, "mousedown", Jh),
              za(t, "touchstart", Jh),
              za(t, "click", Oh, !0),
              za(t, "contextmenu", wh);
        ...
        return (
          ...
          Ye &&
            "soft" !== e &&
            Ye.untrack(f || h, W ? "x,y" : G ? "rotation" : "top,left"),
          f && f.disable(),
          wa(xh),
          (j.isDragging = j.isPressed = m = !1),
          n && Pa(j, "dragend", "onDragEnd"),
          j
        );
      }),
      ...
      ~n.indexOf("scroll") &&
        ...
        (h.style.overflowY = U && !Ee ? "auto" : "hidden"),
        (h.style.overflowX = J && !Ee ? "auto" : "hidden"),
        (h = f.content)),
      G ? (o.rotation = 1) : (J && (o[V] = 1), U && (o[K] = 1)),
