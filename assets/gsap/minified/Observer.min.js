    ...
    Ce = {
      ...
      sc: E(function (e) {
        return arguments.length
          ? Me.scrollTo(e, Se.sc())
          : Me.pageXOffset || Ae[n] || De[n] || Oe[n] || 0;
      }),
    },
    Se = {
      s: c,
      ...
      sc: E(function (e) {
        return arguments.length
          ? Me.scrollTo(Ce.sc(), e)
          : Me.pageYOffset || Ae[c] || De[c] || Oe[c] || 0;
      }),
    };
  (Ce.op = Se), (a._scrollers.cache = 0);
  var s =
      ...
      function qc() {
        ...
        E && (n || r) && E(se, e, t, ye, xe),
          ...
          r &&
            ...
            (le = se.deltaY),
            (xe[0] = xe[1] = xe[2] = 0)),
          (re || ne) && (k && k(se), ne && (v(se), (ne = !1)), (re = !1)),
          ie && !(ie = !1) && $ && $(se),
          oe && (V(se), (oe = !1)),
          (ee = 0);
      }
      ...
      (te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed &&
              (se._vx.reset(), se._vy.reset(), A(S ? i : he, ze[1], tc, !0)),
